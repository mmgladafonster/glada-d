    ...
    <>
      ...
      <form action={handleFormAction} className="space-y-4 md:space-y-6">
        ...
        >
          {isPending ? (
            <>
              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div> Skickar...
            </>
          ) : (
            <>
              Skicka Förfrågan{" "}
...
export default function ContactPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Ja, vi förbehåller oss rätten att neka kunder som. Vi strävar efter partnerskap baserade på ömsesidig respekt.",
    },
  ]
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto font-light leading-relaxed">
                Kontakta oss idag för en kostnadsfri offert. Vi svarar inom 15 minuter och kan ofta erbjuda service
                samma dag.
              </p>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              <div>
                ...
                <p className="text-lg md:text-xl text-gray-600 mb-6 md:mb-8 leading-relaxed font-light">
                  Redo för kristallklara fönster? Kontakta oss med någon av metoderna nedan. Vi är här för att hjälpa
                  dig med alla dina fönsterputsbehov.
                </p>
